...
func TestRegisterRoutesPreservesFinanceAPI(t *testing.T) {
	...
	expected := map[string]struct{}{
		...
		http.MethodPatch + " /api/goals/:id":                 {},
		http.MethodDelete + " /api/goals/:id":                {},
		http.MethodGet + " /api/mcc-rules":                   {},
		http.MethodPost + " /api/mcc-rules":                  {},
		http.MethodDelete + " /api/mcc-rules/:id":            {},
		http.MethodPatch + " /api/transactions/:id/category": {},
	}
