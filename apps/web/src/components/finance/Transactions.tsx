...
export function TransactionList({ transactions }: { transactions: Transaction[] }) {
  ...
  return <div className="grid"><AnimatePresence initial={false}>{transactions.map((transaction) => <TransactionItem key={transaction.id} transaction={transaction} />)}</AnimatePresence></div>
}
